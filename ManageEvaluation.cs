...
namespace MidProjectUI
{
    public partial class ManageEvaluation : Form
    {
        ...
        private void showEvalBtn_Click_1(object sender, EventArgs e)
        {
        ...
        private void updateEvalBtn_Click_1(object sender, EventArgs e)
        {
            var con = Configuration.getInstance().getConnection();
        ...
        private void addEvalBtn_Click_1(object sender, EventArgs e)
        {
